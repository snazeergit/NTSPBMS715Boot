...
public class BootProj10LayeredAppProfilesYAMLFilesApplication {

	@Autowired
	private Environment env;

	public BootProj10LayeredAppProfilesYAMLFilesApplication() {
		System.out.println(
	...
	public static void main(String[] args) {
		ApplicationContext ctx = SpringApplication.run(BootProj10LayeredAppProfilesYAMLFilesApplication.class,
				args);
